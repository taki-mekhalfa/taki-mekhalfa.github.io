...
## <u>Why concurrency control at the DB level?</u>
...
#### <u>Everything is a transaction!</u>
...
#### <u>Concurrency is desirable but can be dangerous!</u>
...
One of the many responsibilities of a scheduler is to schedules tasks for execution but 
...
## <u>Repeatable Read Isolation Level</u>
...
## <u>Serializable Isolation Level</u>
...
Applications with complex business logic and high concurrent interactions might prefer `Serializable` isolation level 
